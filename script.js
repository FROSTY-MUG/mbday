...
// ──────────────────────────────────────────────
// ART CANVAS (Pastel Watercolor Painter)
// ──────────────────────────────────────────────
(function initArtCanvas() {
  ...
  const pastelColors = [
    "rgba(251, 113, 133, 0.45)", // pink
    "rgba(191, 219, 254, 0.45)", // blue
    "rgba(233, 213, 255, 0.45)", // purple
    "rgba(254, 240, 138, 0.45)", // yellow
    "rgba(187, 247, 208, 0.45)"  // green
  ];
  ...
  function draw(e) {
    ...
    ctx.lineWidth = Math.random() * 25 + 10;
